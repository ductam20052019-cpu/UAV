...
#include "util.h"
float motors[4];
#define MOTOR_0_PIN  13 // rear left   (Lệnh mrl)
#define MOTOR_1_PIN  14 // rear right  (Lệnh mrr)
#define MOTOR_2_PIN  27 // front right (Lệnh mfr)
#define MOTOR_3_PIN  26 // front left  (Lệnh mfl)
...
#define PWM_STOP 1000     // us
#define PWM_MIN  1050     // us  <-- IDLE (cao hơn 1040)
